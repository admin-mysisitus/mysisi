    ...
    if (container) {
      container.innerHTML = `
        <div style="text-align: center; padding: 60px 20px;">
          ...
          <h2>${error.message}</h2>
          <a href="/my/dashboard/" class="btn" style="display: inline-block; margin-top: 20px; padding: 12px 24px; background: #2563EB; color: white; text-decoration: none; border-radius: 5px;">
  ...
  container.innerHTML = `
    <div class="invoice-wrapper">
      ...
      <div class="invoice-actions no-print">
        ...
        <a href="/my/dashboard/" class="inv-btn inv-btn-primary">
